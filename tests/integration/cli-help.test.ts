...
describe("CLI Help Integration", () => {
  it("should display help when no arguments provided", async () => {
    ...
    expect(stdout).toContain("claude-cmd is a CLI tool that helps you discover, install, and manage");
  ...
  it("should display help for specific command", async () => {
    ...
    expect(stdout).toContain("Add downloads and installs a Claude Code slash command");
    expect(stdout).toContain("Usage:");
    expect(stdout).toContain("claude-cmd add");
